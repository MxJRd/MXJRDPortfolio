...
const ResumeCard = ({ name, setCompany, company, logo }: { name: string, setCompany: (company: JobContentType) => void, company: JobContentType, logo?: any }) => {
  ...
  return (
    <article className='bg-[#CCCCCC] rounded-md p-4 shadow-lg min-w-[300px] shadow-inner'>
        <div className='relative w-6 h-6 rotate-45 -translate-y-7 translate-x-68 bg-raisin-black'></div>
