const aboutStrings = {
  ...
  achievements: {
    title: 'Achievements',
    content: `I am a highly motivated individual with a proven track record of success. As an endorsed drummer, I had the opportunity to play professionally alongside my childhood heroes, Red Jumpsuit Apparatus, Drowning Pool, and more.
