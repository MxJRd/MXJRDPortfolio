...
const ArticleCard = ({ content, title }: { content: string, title: string }) => {
  ...
  return (
    <article ref={articleRef} className='relative'>
      <ul className='flex flex-col gap-12 px-8 text-white text-start min-w-180 md:pl-48'>
        ...
        <li className='flex flex-col gap-5.5 left-96'>
          ...
          <p className='xl:min-w-[675px] xl:max-w-[675px] lg:min-w-[675px] lg:max-w-[675px] md:min-w-[550px] md:max-w-[550px] sm:min-w-[425px] sm:max-w-[425px] font-roboto font-md animate-slide-from-right tracking-wider'>
            {content}
          </p>
        </li>
      </ul>
