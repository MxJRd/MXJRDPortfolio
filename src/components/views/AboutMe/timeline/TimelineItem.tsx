  ...
  return (
    <li className="relative mb-6 sm:mb-0">
      <div className="flex items-center">
        <div className={`z-10 flex items-center justify-center w-6 h-6 rounded-full ring-0 ring-white md:ring-8 ${current ? 'dark:ring-white bg-pink-500' : 'dark:ring-gray-900 dark:bg-blue-900'} shrink-0`}>
      ...
      <div className="mt-3 md:pe-8">
        ...
        <h2 className='block mb-2 text-md font-semibold leading-none text-gray-900 dark:text-white'>{employer}</h2>
